...
class LaneDetector:
    ...
    def __init__(self):
        ...
        self.nn_model = p2_nn_conv.SmallerNet().to(get_default_torch_device())
        self.nn_model.load_state_dict(torch.load("nn_weights"))
    ...
    def lane_detector(self, input_image, depth_img=None, video_mode=False):
        ...
        batch = prepare_images_for_nn([image])
        hsv_filtered = model(batch).to("cpu")
