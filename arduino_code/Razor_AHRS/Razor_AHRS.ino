...
const float magn_ellipsoid_center[3] = {-2.66188e+06, 352328, 445297};
const float magn_ellipsoid_transform[3][3] = {{0.447561, 0.0381775, 0.0834373}, {0.0381775, 0.436948, 0.137178}, {0.0834373, 0.137178, 0.950937}};
