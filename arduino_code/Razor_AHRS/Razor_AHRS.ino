...
#define ACCEL_Y_MAX ((float) 248)
#define ACCEL_Z_MIN ((float) -290)
#define ACCEL_Z_MAX ((float) 232)

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
#define MAGN_X_MIN ((float) -392.00)
#define MAGN_X_MAX ((float) 661.00)
#define MAGN_Y_MIN ((float) -599.0)
#define MAGN_Y_MAX ((float) 496.00)
#define MAGN_Z_MIN ((float) -505.00)
#define MAGN_Z_MAX ((float) 474.00)

//magn x,y,z (min/max) = -392.00/661.00  -599.00/496.00  -505.00/474.00
...
//#define CALIBRATION__MAGN_USE_EXTENDED true
//const float magn_ellipsoid_center[3] = {-416417, 34473.5, 503859};
//const float magn_ellipsoid_transform[3][3] = {{0.711808, 0.0151303, 0.223261}, {0.0151303, 0.600882, 0.0130536}, {0.223261, 0.0130536, 0.825501}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -26.46)
#define GYRO_AVERAGE_OFFSET_Y ((float) 58.35)
#define GYRO_AVERAGE_OFFSET_Z ((float) -9.04)
